...
o.scrolloff = 4 -- scroll extra 4 lines
o.sidescrolloff = 14 -- scroll extra 14 columns
...
vim.api.nvim_create_user_command("MyConfig", function() vim.cmd "e ~\\AppData\\Local\\nvim" end, {})
